...
public interface ProtocolConfig extends Config {
    ...
    interface Descriptions {
        ...
        String P_SELECT_MILESTONE = DescriptionHelper.PROB_OF + "requesting a confirmed transaction from a neighbor. This should be a large since it is imperative that we find milestones to get transactions confirmed";
        ...
        String P_REPLY_RANDOM_TIP = DescriptionHelper.PROB_OF + "replying to a random transaction request, when your node has something to request.";
